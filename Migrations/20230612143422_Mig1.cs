        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupervisorUniversityId = table.Column<int>(type: "int", nullable: true),
                    SupervisorCompanyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Students_CompanySupervisors_SupervisorCompanyId",
                        column: x => x.SupervisorCompanyId,
                        principalTable: "CompanySupervisors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Students_UniversitySupervisors_SupervisorUniversityId",
                        column: x => x.SupervisorUniversityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Students_SupervisorCompanyId",
                table: "Students",
                column: "SupervisorCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_SupervisorUniversityId",
                table: "Students",
                column: "SupervisorUniversityId");
        }
